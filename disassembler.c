...
int Disassemble(unsigned char *buffer, int pc){
    ...
    // fsize gives size in bytes, thus, each step in pc is a byte
    ...
    switch (*code){
        ...
        case 0x21: printf("LXI    H,#$%02x%02x", code[2], code[1]);
                    opbytes=3; break;
        case 0x22: printf("SHDL   #$%02x%02x", code[2], code[1]);
                    opbytes=3; break;
        ...
        case 0x3a: printf("LDR    #$%02x%02x", code[2], code[1]);
                    opbytes=3; break;
